...
/* App Information */
var App_Title = "College Stuff";
var App_Version_Title = "College Stuff";
var App_Version_Number = "1.0";
var App_Version_ContinuityNumber = "1.0"
var App_Version_BuildNumber = 4153;
var App_CopyrightTitle = "Content By ElmerF 2024";
var App_Version_ELMSUI = "2.0";
...
let Startup_NavigationList_Array_Links = ["App_TemplateV1.html"]; //Launcher navigation links
let Startup_NavigationList_Array_Icons = ["favicon_old.png"];


/* App Default Page Properties */
var pageProperty_MenuName = "App by ElmerF"; // Refers to the name displayed on the main menu
...
function Startup_Load_Properties(){
    ...
    switch(App_CurrentPageName){
        case "App_Template_V1.html":
            ...
            pageProperty_MenuName = "ERUMA UI Template";
...
function Startup_Set_Properties(){
	...
	} else if (pageProperty_enableStatusBar == 1){
		SetPageProperties_Header_StatusBarValue = "auto";
	}
	...
	if (pageProperty_enableFullContainerMode == 1){
		...
		document.getElementById("pageElement_Content").style.marginTop = "0px";
		document.getElementById("Page_MainContent").style.padding = "0px";
		document.getElementById("Page_MainContent").style.marginTop = "0px";
...
function Startup_Set_VersionInfo(){
	...
	document.getElementById("pageElement_PageTitle").innerHTML = App_Version_Title + " - " + pageProperty_PageTitle;
